...
public class MonShopContext : IdentityDbContext<ApplicationUser>, IDbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        optionsBuilder.UseSqlServer(
            "server=.;database=MonShop;uid=sa;pwd=12345;TrustServerCertificate=True;MultipleActiveResultSets=True");
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<IdentityRole>().HasData(
            new IdentityRole
            {
                Id = Guid.NewGuid().ToString(), Name = Permission.ADMIN, NormalizedName = Permission.ADMIN.ToLower()
            });

        modelBuilder.Entity<IdentityRole>().HasData(
            new IdentityRole
            {
                Id = Guid.NewGuid().ToString(), Name = Permission.STAFF, NormalizedName = Permission.STAFF.ToLower()
            });

        modelBuilder.Entity<IdentityRole>().HasData(
            new IdentityRole
                { Id = Guid.NewGuid().ToString(), Name = Permission.USER, NormalizedName = Permission.USER.ToLower() });
        ...
        modelBuilder.Entity<Product>().HasData(
            new Product
            {
                ...
                ImageUrl =
                    "https://media.coolmate.me/cdn-cgi/image/width=672,height=990,quality=85,format=auto/uploads/December2021/1-copy-2_99.jpg",
                Price = 19.99,
                Discount = 5.00,
            ...
            new Product
            {
                ...
                ImageUrl =
                    "https://media.coolmate.me/cdn-cgi/image/quality=80,format=auto/uploads/April2023/somicfxam4.jpg",
                Price = 29.99,
                Discount = null,
            ...
            new Product
            {
                ...
                ImageUrl =
                    "https://aldo.com.sa/cdn/shop/collections/s22_q1_w_vday_accessories_cluster_4467-547936.jpg?v=1644355846",
                Price = 27.99,
                Discount = 4.50,
