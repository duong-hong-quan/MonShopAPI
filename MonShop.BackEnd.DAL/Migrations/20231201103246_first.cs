...
namespace MonShop.BackEnd.DAL.Migrations
{
    public partial class first : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "RoomMemberChats",
                columns: table => new
                {
                    RoomMemberChatID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RoomID = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoomMemberChats", x => x.RoomMemberChatID);
                    table.ForeignKey(
                        name: "FK_RoomMemberChats_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RoomMemberChats_Room_RoomID",
                        column: x => x.RoomID,
                        principalTable: "Room",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Message_RoomMemberChats_RoomMemberChatId",
                        column: x => x.RoomMemberChatId,
                        principalTable: "RoomMemberChats",
                        principalColumn: "RoomMemberChatID",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "334fadb1-b04a-44b0-bef5-82ecc53d513b", "2b87a976-3891-4cd2-a9e7-ec3391be9a28", "ADMIN", "admin" },
                    { "47adbc5f-e6bd-40b4-b431-5d5b16eab51d", "d1c19e72-d145-4177-a98d-29d3a109de1c", "USER", "user" },
                    { "6b8cfbc7-303e-4c7f-921d-736a2b60b6ee", "fb5fc4a9-c6fe-4bb5-ae08-2ff65201aeec", "STAFF", "staff" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Message_RoomMemberChatId",
                table: "Message",
                column: "RoomMemberChatId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoomMemberChats_RoomID",
                table: "RoomMemberChats",
                column: "RoomID");

            migrationBuilder.CreateIndex(
                name: "IX_RoomMemberChats_UserId",
                table: "RoomMemberChats",
                column: "UserId");
        }
